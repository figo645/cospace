				...
				<table border="0" class="framewidth" height="116" cellpadding="0"
					...
					<tr>
						<td width="308" rowspan="2" class="leftgray">
							<img name="news_r1_c1" src="images/news_r1_c1.jpg" width="308"
...
<!-- ===MENU==== -->
												<logic:notEmpty name="dynamicstate">
												<tr>
												<td class="leftsubfont">新闻动态</td>
												</tr>
												<tr>
															<td height="10"></td>
														</tr>
													<logic:iterate id="blogMasterObj" name="dynamicstate"
														indexId="blogIdx">
														<tr>
															<td>
															...
															ajaxFunction(${subBlogForm.id});
																...
																<html:link action="/showBlogEditorArchDesign"
		...
		&nbsp;<bean:write name="blogMasterObj"
												...
												<logic:notEmpty name="cultureactive">
												<tr>
												<td class="leftsubfont">文化活动</td>
												</tr>
												<tr>
															<td height="10"></td>
														</tr>
													<logic:iterate id="blogMasterObj" name="cultureactive"
														indexId="blogIdx">
														<tr>
															<td>
															<bean:define id="blogFormId"  name="subBlogForm" property="id" />
