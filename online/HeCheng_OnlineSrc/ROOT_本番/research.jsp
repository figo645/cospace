				...
				<table border="0" class="framewidth" height="116" cellpadding="0"
					...
					<tr>
						<td width="308" rowspan="2" class="leftgray">
							<img name="news_r1_c1" src="images/research_r2_c1.jpg" width="308"
...
<!-- ===MENU==== -->
		 ...
		 <bean:write name="blogMasterObj" property="formatCreatedate"/>&nbsp;<bean:write name="blogMasterObj"
																		property="title" />
																</html:link>
