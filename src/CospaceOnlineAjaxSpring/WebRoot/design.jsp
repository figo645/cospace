										...
										<span class="titleleft">
											<logic:notEmpty
												...
												<logic:iterate id="blogMasterObj" name="menuLst">
													<bean:define id="blogObj" name="blogMasterObj"></bean:define>
												</logic:iterate>
											</logic:notEmpty> <logic:notEmpty name="blogObj">
												<bean:write name="blogObj" property="categoriesCN" />
											</logic:notEmpty> </span>
									</td>
								</tr>
								<tr>
													...
													<logic:iterate id="blogMasterObj" name="menuLst"
														...
														<tr>
															...
															ajaxFunction(${subBlogForm.id});
																...
																<html:link action="/showBlogEditorDesign"
